        ...
        <div class="w-10/12 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto justify-center">
            <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm">Order over trillion dollars</p>
                </div>
            </div>
            <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm">Just forget about it</p>
                </div>
            </div>
            <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm">From February 31</p>
                </div>
            </div>
        </div>
    </div>
